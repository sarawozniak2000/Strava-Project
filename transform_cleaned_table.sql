...
SELECT
    ...
    start_latlng,
    end_latlng,
    start_latlng[OFFSET(0)] AS start_latitude,
    start_latlng[OFFSET(1)] AS start_longitude,
    end_latlng[OFFSET(0)] AS end_latitude,
    end_latlng[OFFSET(1)] AS end_longitude,
